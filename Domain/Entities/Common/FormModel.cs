...
namespace NgenV4.Domain.Entities
{
    public class FormModel
    {
        ...
        public List<FormModelFields> fields { get; set; }
        public List<FormModelGroups> groups { get; set; }
        public List<FormModelCollections> collections { get; set; }
    }

    public class FormModelFields
    {
        public string id { get; set; }
        ...
        public List<FormModelLOV> list { get; set; }
        public List<FormRadioList> radioList { get; set; }
    }

    public class FormModelGroups
    {
        public string type { get; set; }
    ...
    public class FormModelLOV
    {
        public string id { get; set; }
        public string text { get; set; }
    }

    public class FormRadioList
    {
